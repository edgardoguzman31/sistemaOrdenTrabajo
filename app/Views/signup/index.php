    ...
    <div class="login-box" style="border: black solid 4px;">
        ...
        <div class="card card-outline card-primary">
            ...
            <div class="card-body">
                ...
                <form action="<?php echo base_url(); ?>registersave" method="POST">
                <h1 style="text-align: center; font-size:25px;">REGISTRO</h1>
                    ...
                    <div class="input-group mb-3">
                        <input type="text" id="email" name="email" class="form-control" placeholder="Correo o usuario" required>
                        <div class="input-group-append">
                            <div class="input-group-text">
                                <span class="fas fa-envelope"></span>
                            </div>
                    ...
                    <div class="input-group mb-3">
                        <input type="text" id="usuario" name="usuario" class="form-control" placeholder="Codigo de Empleado" required>
                        <div class="input-group-append">
                            <div class="input-group-text">
                                <span class="fas fa-envelope"></span>
                            </div>
