...
<body>
    ...
    <form action="<?php echo base_url(); ?>dashboard/guardaredicion" method="POST">
        ...
        <div class="form-field">
            <label for="no_ot" class="form-label">No. OT:</label>
            <input type="text" id="no_ot" name="no_ot" class="form-input" value="<?php echo $registro['no_ot']; ?>">
        </div>
        <div class="form-field">
            <label for="no_st" class="form-label">No. ST:</label>
            <input type="text" id="no_st" name="no_st" class="form-input" value="<?php echo $registro['no_st']; ?>">
        </div>
